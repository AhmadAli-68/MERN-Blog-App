                ...
                {blogCategories.map((item) => (
                    ...
                    >
                        <button
                            ...
                            className={`text-gray-500 cursor-pointer ${menu === item && 'text-white px-4 pt-0.5'}`}>
                            {item}
                            {menu === item && (
                                <motion.div
                                    layoutId='underline'
                                    transition={{ type: 'spring', stiffness: 500, damping: 30 }}
                                    className='bg-primary h-7 absolute left-0 right-0 top-0 -z-1 rounded-full'></motion.div>
                            )}
                        </button>
                    </div>
                ))}
